...
class MetricsResidue():
    def __init__(self, mmol_residue, index_in_chain=None, previous_residue=None, next_residue=None, parent_chain=None, molprobity_data=None):
        ...
        reflections_handler = self.parent_chain.parent_model.reflections_handler
